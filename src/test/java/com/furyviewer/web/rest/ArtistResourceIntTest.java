...
public class ArtistResourceIntTest {
    ...
    /*public void setup() {
        ...
        final ArtistResource artistResource = new ArtistResource(artistRepository, hatredArtistRepository, favouriteArtistRepository, artistServiceSmart, artistBQueryService, artistService, episodeActorsService, artistTypeRepository, marksService);
