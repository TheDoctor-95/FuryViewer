...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.furyviewer.domain.Series.class.getName() + ".actors", jcacheConfiguration);
            ...
            cm.createCache(com.furyviewer.domain.Artist.class.getName() + ".movieActors", jcacheConfiguration);
            cm.createCache(com.furyviewer.domain.Artist.class.getName() + ".seriesActors", jcacheConfiguration);
